# -*- coding: utf-8 -*-
"""“VAE_autoencoder.ipynb”

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1p4jOV1wztEto_vSb8-vysTgSYy-4Vfo4
"""
...
a=np.reshape(X_train_initial[333],(img_size,img_size))
plt.imshow(a)
...
X_train, X_test, y_train, y_test = train_test_split(data_contours, signal_data, test_size=0.221, random_state=42)
...
def encoder_layers(latent_dim,input_img,input_signal):
  ...
  return mu, sigma, cont

def decoder_layers(input1,input2,cont):
  '''Defines the decoder path to upsample back to the original image size.'''
  #units = conv_shape[1] * conv_shape[2] * conv_shape[3]
  x1 = tf.keras.layers.Dense(4000, activation = 'relu', name="decode_dense1")(input1)
  x1 = tf.keras.layers.BatchNormalization()(x1)
...
vae_auto_models.save(r'/content/drive/MyDrive/Colab Notebooks/fianl_project/model/model300_singlevae_lat2500.h5')

vae_auto_models = tf.keras.models.load_model(r'/content/drive/MyDrive/Colab Notebooks/fianl_project/model/model300_singlevae_lat4000.h5')
